...
return new class extends Migration
{
    ...
    {
        Schema::create('saka_komponen_nilai_assesmen', function (Blueprint $table) {
            $table->id('id_komponen_nilai_assesmen');
    ...
    {
        Schema::dropIfExists('saka_komponen_nilai_assesmen');
    }
};