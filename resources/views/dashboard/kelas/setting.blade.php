                        ...
                        <div class="p-4 space-y-5">
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    <input type="text" name="kode_kelas" class="py-1.5 sm:py-2 px-3 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600"
                                    placeholder="Masukan kode kelas" value="{{ $data->kode_kelas }}" autocomplete="off">
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Grid -->
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    <input type="text" name="nama_kelas" class="py-1.5 sm:py-2 px-3 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600"
                                    placeholder="Masukan nama kelas" value="{{ $data->nama_kelas }}" autocomplete="off">
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Grid -->
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    <input type="text" name="tingkat" class="py-1.5 sm:py-2 px-3 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600"
                                    placeholder="Masukan tingkat kelas" value="{{ $data->tingkat }}" autocomplete="off">
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Grid -->
            ...
            <div class="p-6 bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
                <div class=" w-full flex justify-between">
                    <div class="w-full text-sm">
                        ...
                        <p class="text-xs text-gray-500 dark:text-neutral-500">{{ empty($data['siswas']) ? 'Tidak ada siswa' : 'Total '.count($data['siswas']).' data siswa' }}</p>
                    </div>
                    <div>
                ...
                <div class="py-3">
                    ...
                    <div class="max-w-sm mx-auto text-sm text-center">
                        <p class="mt-2 font-medium text-gray-800 dark:text-neutral-200">
                            Tidak ada siswa tercatat
                        </p>
                        <p class="mb-5 text-sm text-gray-500 dark:text-neutral-500">
                            Daftar data siswa akan tampil disini
                        </p>
                    </div>
                </div>
                @endforelse
