@php
    ...
    $action_param = $data->id_wali_siswa;
@endphp
<x-app :page='$page'>
    <div class="p-2 sm:p-5 sm:py-0 md:pt-5 space-y-5">
        ...
        <div class="flex flex-col pt-3 gap-y-5 max-w-xl mx-auto">
            ...
            <div class="bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
                <form action="{{ route($page.'.update.action', [$id_siswa, $action_param]) }}" method="post">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="p-4 space-y-5">
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    <input type="text" name="nama_wali" class="py-1.5 sm:py-2 px-3 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600"
                                    placeholder="Nama wali siswa" value="{{ $data->nama_wali }}" autocomplete="off">
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Grid -->
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    ...
                                    placeholder="Masukan kontak wali siswa" value="{{ $data->kontak }}" autocomplete="off">
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    ...
                                    placeholder="Masukan alamat wali siswa" value="{{ $data->alamat }}" autocomplete="off">
                                     <p class="mt-1 text-xs text-gray-500 dark:text-neutral-400">
                                        Opsional, boleh dikosongkan.
                                    </p>
                                </div>
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    <input type="text" name="status_wali" class="py-1.5 sm:py-2 px-3 block w-full border-gray-200 rounded-lg sm:text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600"
                                    placeholder="Status wali siswa" value="{{ $data->status_wali }}" autocomplete="off">
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Grid -->
        ...
        <div class="w-full flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            <div class="p-7">
                ...
                <div class="flex justify-end items-center gap-x-2  ">
                    ...
                    <form method="post" action="{{ route($page.'.delete.action', [$id_siswa, $action_param]) }}">
                        @csrf
                        @method('DELETE')
