    ...
    <div class="p-2 sm:p-5 sm:py-0 md:pt-5 space-y-5">
      ...
      <div class="flex flex-col gap-y-5 max-w-xl mx-auto">
        ...
        <div class="bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
          <form action="{{ route('data-nilai.go') }}" method="post">
            @csrf
              ...
              <div class="p-4 space-y-5">
                ...
                <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                  ...
                  <div class="sm:col-span-9">
                    <!-- Select -->
                    <select disabled data-hs-select='{
                        "hasSearch": true,
                        ...
                        <option selected>{{ $mapel->nama_mapel }} - {{ $mapel->kode_mapel }}</option>
                  ...
                  <div class="sm:col-span-9">
                    ...
                    <select data-hs-select='{
                        ...
                        @foreach ($data as $item)
                            <option value="{{ $item->id_kelas }}" data-hs-select-option='{
                                "description": "{{ $item->jumlah_siswa > 0 ? $item->jumlah_siswa.' Siswa' : 'Tidak ada siswa' }}"
