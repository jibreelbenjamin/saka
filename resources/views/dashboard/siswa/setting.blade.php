                        ...
                        <div class="p-4 space-y-5">
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    <select data-hs-select='{
                                        ...
                                        "toggleClasses": "hs-select-disabled:pointer-events-none hs-select-disabled:opacity-50 relative py-2 ps-4 pe-9 flex text-nowrap w-full cursor-pointer bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 text-gray-800 dark:text-white rounded-lg text-start text-sm hover:bg-gray-50 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-gray-50 dark:focus:bg-neutral-700",
                                    ...
                                    <option value="" {{ old('id_kelas') || $data->id_kelas ? '' : 'selected' }}>Pilih Kelas</option>
                                    @foreach ($kelas as $item)
                                    <option value="{{ $item->id_kelas }}" {{ $data->id_kelas == $item->id_kelas ? 'selected' : '' }} data-hs-select-option='{
                                        "description": "{{ $item->kode_kelas }}"
                                        }'>
                                        {{ $item->nama_kelas }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    ...
                                    placeholder="Masukkan username" value="{{ $data->username }}" autocomplete="off">
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Grid -->
                            ...
                            <div class="grid sm:grid-cols-12 gap-y-1.5 sm:gap-y-0 sm:gap-x-5">
                                ...
                                <div class="sm:col-span-9">
                                    ...
                                    placeholder="Masukkan nama lengkap" value="{{ $data->nama }}" autocomplete="off">
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Grid -->
                        ...
                        <div>
                            @if(count($data['waliSiswa'] ?? []) >= 2)
                                <div class="relative inline-flex group">
                                    <button type="button" disabled class="py-2 px-3 inline-flex justify-center items-center gap-x-2 text-nowrap text-start text-xs bg-blue-600 border border-blue-600 text-white text-sm font-medium rounded-lg shadow-2xs align-middle hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:ring-1 focus:ring-blue-300 dark:focus:ring-blue-500">
                                        Tambah wali
                                    </button>
